    ...
    <div className="relative grid place-items-center">
      ...
      >
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(20,241,149,0.5), transparent 65%)" }}
        />
        {/* diamond */}
        <div
          className="relative h-20 w-20 rotate-45 rounded-lg border border-white/30"
          style={{
            background: "linear-gradient(135deg, rgba(20,241,149,0.9), rgba(153,69,255,0.9))",
      ...
      <div className="mt-6 text-center">
        <div className="font-display text-xs tracking-[0.3em] text-arena-sol">JUDGING CRYSTAL</div>
